// Command Nextbike-cli is a CLI + REPL for the Nextbike SDK,
...
const prompt = "nextbike"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "live_data public reservation reservation_status"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      NEXTBIKE_APIKEY (api key), NEXTBIKE_BASE (base url override)")
...
func run(args []string, in io.Reader, out, errOut io.Writer) int {
	...
	// Configure from the environment: NEXTBIKE_APIKEY carries the API key and
	// NEXTBIKE_BASE optionally overrides the API base URL (e.g. production).
	// Both injectable by a secrets vault. Unset -> nil config defaults.
	var opts map[string]any
	if apikey := os.Getenv("NEXTBIKE_APIKEY"); apikey != "" {
		opts = map[string]any{"apikey": apikey}
	}
	if base := os.Getenv("NEXTBIKE_BASE"); base != "" {
		if opts == nil {
			opts = map[string]any{}
		}
		opts["base"] = base
	}
	client := sdk.NewNextbikeSDK(opts)
