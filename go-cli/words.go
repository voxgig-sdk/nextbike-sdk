...
func registerSDKWords(r *eng.Registry, client *sdk.NextbikeSDK) {
...
func runOp(client *sdk.NextbikeSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
