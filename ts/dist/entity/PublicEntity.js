...
class PublicEntity extends NextbikeEntityBase_1.NextbikeEntityBase {
    ...
    make() {
        return new PublicEntity(this._client, this.entopts());
    }
...
//# sourceMappingURL=PublicEntity.js.map