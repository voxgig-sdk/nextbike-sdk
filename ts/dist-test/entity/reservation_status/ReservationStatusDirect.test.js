...
(0, node_test_1.describe)('ReservationStatusDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-reservation_status', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-reservation_status', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.NEXTBIKE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.NextbikeSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.NEXTBIKE_APIKEY,
        }));
        let idmap = env['NEXTBIKE_TEST_RESERVATION_STATUS_ENTID'];
    ...
    const client = new __1.NextbikeSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ReservationStatusDirect.test.js.map