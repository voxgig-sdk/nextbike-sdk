...
(0, node_test_1.describe)('PublicEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'public.' + op, live))
                return;
        }
        ...
        let public_ref01_data = Object.values(setup.data.existing.public)[0];
        // LOAD
        const public_ref01_ent = client.Public();
        const public_ref01_match_dt0 = {};
        const public_ref01_data_dt0 = (await public_ref01_ent.load(public_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != public_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/public/PublicTestData.json');
    ...
    let idmap = transform(['public01', 'public02', 'public03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['NEXTBIKE_TEST_PUBLIC_ENTID'];
...
//# sourceMappingURL=PublicEntity.test.js.map