...
(0, node_test_1.describe)('PublicDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-public', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-public', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['NEXTBIKE_TEST_PUBLIC_ENTID'];
...
//# sourceMappingURL=PublicDirect.test.js.map