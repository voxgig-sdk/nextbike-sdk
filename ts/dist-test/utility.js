...
function envOverride(m) {
    if ('TRUE' === process.env.NEXTBIKE_TEST_LIVE ||
        'TRUE' === process.env.NEXTBIKE_TEST_OVERRIDE) {
    ...
    m.NEXTBIKE_TEST_EXPLAIN = process.env.NEXTBIKE_TEST_EXPLAIN || m.NEXTBIKE_TEST_EXPLAIN;
    return m;
}
