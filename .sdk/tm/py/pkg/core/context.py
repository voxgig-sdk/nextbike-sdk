...
from projectname_sdk.core.control import NextbikeControl
...
class NextbikeContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, NextbikeResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, NextbikeResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return NextbikeError(code, msg, self)
