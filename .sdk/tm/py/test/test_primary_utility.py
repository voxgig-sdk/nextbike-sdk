...
from projectname_sdk import NextbikeSDK
from projectname_sdk.core.spec import NextbikeSpec
from projectname_sdk.core.result import NextbikeResult
from projectname_sdk.core.response import NextbikeResponse
from projectname_sdk.core.operation import NextbikeOperation
from projectname_sdk.core.error import NextbikeError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import NextbikeBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = NextbikeSDK.test(None, None)
        ...
        class TestInitFeature(NextbikeBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(NextbikeBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = NextbikeSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = NextbikeSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = NextbikeSDK.test(None, setup_opts)
