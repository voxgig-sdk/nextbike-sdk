...
class NextbikeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = NextbikeTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = NextbikeTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = NextbikeTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
