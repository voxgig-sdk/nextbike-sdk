...
class NextbikeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = NextbikeTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = NextbikeTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = NextbikeTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
