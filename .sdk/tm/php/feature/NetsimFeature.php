...
class NextbikeNetsimFeature extends NextbikeBaseFeature
{
    ...
    private function _simulate(NextbikeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(NextbikeContext $ctx, array $applied): void
    {
        $client = $this->client;
