...
class NextbikeCacheFeature extends NextbikeBaseFeature
{
    ...
    private function _through(NextbikeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
