...
class NextbikeRbacFeature extends NextbikeBaseFeature
{
    ...
    private function _required(NextbikeContext $ctx): ?string
    {
    ...
    private function _reject(NextbikeContext $ctx, string $required): void
    {
    ...
    private function _track(NextbikeContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
