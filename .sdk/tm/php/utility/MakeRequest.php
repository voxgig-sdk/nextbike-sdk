...
// Nextbike SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class NextbikeMakeRequest
{
    public static function call(NextbikeContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new NextbikeResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new NextbikeResponse($fetched);
        } else {
