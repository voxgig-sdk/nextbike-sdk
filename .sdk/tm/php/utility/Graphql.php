...
class NextbikeGraphql
{
    ...
    // equivalent.
    public static function body(NextbikeContext $ctx): mixed
    {
    ...
    public static function errors(NextbikeContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
