...
// Nextbike SDK utility: fetcher

class NextbikeFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; NextbikeSDK/1.0)';
    ...
    public static function call(NextbikeContext $ctx, string $fullurl, array $fetchdef): array
    {
