...
|---|---|---|
| `ts/` | @voxgig-sdk/nextbike-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/nextbike-sdk \
      --repository voxgig-sdk/nextbike-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/nextbike-sdk` shows it, and
`npm trust revoke @voxgig-sdk/nextbike-sdk --id=<id>` removes it.
