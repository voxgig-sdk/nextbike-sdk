...
describe("ReservationStatusDirect", function()
  it("should direct-load-reservation_status", function()
    local setup = reservation_status_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-reservation_status", setup.live and "live" or "unit")
...
function reservation_status_direct_setup(mockres)
