...
-- data to return.
local TEST_SEED = '{ entity = { ["live_data"] = { ["test01"] = { id = "test01" } }, ["public"] = { ["test01"] = { id = "test01" } }, ["reservation"] = { ["test01"] = { id = "test01" } }, ["reservation_status"] = { ["test01"] = { id = "test01" } } } }'
