...
describe("PublicDirect", function()
  it("should direct-load-public", function()
    local setup = public_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-public", setup.live and "live" or "unit")
...
function public_direct_setup(mockres)
