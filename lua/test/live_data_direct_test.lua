...
describe("LiveDataDirect", function()
  it("should direct-list-live_data", function()
    local setup = live_data_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-live_data", setup.live and "live" or "unit")
