...
local ReservationEntity = {}
ReservationEntity.__index = ReservationEntity


function ReservationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ReservationEntity)
  self._name = "reservation"
  self._client = client
...
function ReservationEntity:get_name()
  return self._name
end


function ReservationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ReservationEntity.new(self._client, opts)
end
...
function ReservationEntity:mark_deleted()
  self._deleted = true
end


function ReservationEntity:deleted()
  return true == self._deleted
end


function ReservationEntity:data_set(args)
  if args ~= nil then
...
function ReservationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ReservationEntity:match_set(args)
  if args ~= nil then
...
function ReservationEntity:match_get()
...
function ReservationEntity:stream(action, args, callopts)
...
function ReservationEntity:_run_op(ctx, post_done)
  local utility = self._utility
