...
const testSeed = `map[string]any{"entity": map[string]any{"live_data": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "public": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "reservation": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "reservation_status": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
