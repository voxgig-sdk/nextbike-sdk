...
func (sdk *NextbikeSDK) OptionsMap() map[string]any {
...
func (sdk *NextbikeSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *NextbikeSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *NextbikeSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *NextbikeSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *NextbikeSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *NextbikeSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("NextbikeSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *NextbikeSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *NextbikeSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("NextbikeSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
