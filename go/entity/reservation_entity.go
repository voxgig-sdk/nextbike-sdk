...
func NewReservationEntity(client *core.NextbikeSDK, entopts map[string]any) *ReservationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ReservationEntity) GetName() string { return e.name }
...
func (e *ReservationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ReservationEntity) Deleted() bool {
	return e.deleted
}


func (e *ReservationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewReservationEntity(e.client, opts)
}

func (e *ReservationEntity) Data(args ...any) any {
...
func (e *ReservationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Reservation; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ReservationEntity) DataTyped(data ...Reservation) Reservation {
	if len(data) > 0 {
		return typedFrom[Reservation](e.Data(asMap(data[0])))
	}
	return typedFrom[Reservation](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Reservation (all fields
// optional at the wire level).
func (e *ReservationEntity) MatchTyped(match ...Reservation) Reservation {
	if len(match) > 0 {
		return typedFrom[Reservation](e.Match(asMap(match[0])))
	}
	return typedFrom[Reservation](e.Match())
}
...
func (e *ReservationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ReservationEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ReservationEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *ReservationEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ReservationCreateData and returns an Reservation. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ReservationEntity) CreateTyped(reqdata ReservationCreateData, ctrl map[string]any) (Reservation, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Reservation{}, err
	}
	return typedFrom[Reservation](res), nil
}



func (e *ReservationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ReservationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ReservationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
