...
func NewPublicEntity(client *core.NextbikeSDK, entopts map[string]any) *PublicEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PublicEntity) GetName() string { return e.name }
...
func (e *PublicEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PublicEntity) Deleted() bool {
	return e.deleted
}


func (e *PublicEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPublicEntity(e.client, opts)
}

func (e *PublicEntity) Data(args ...any) any {
...
func (e *PublicEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *PublicEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PublicEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PublicEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PublicEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PublicEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PublicEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
