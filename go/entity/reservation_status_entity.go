...
type ReservationStatusEntity struct {
	name    string
...
func NewReservationStatusEntity(client *core.NextbikeSDK, entopts map[string]any) *ReservationStatusEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ReservationStatusEntity) GetName() string { return e.name }
...
func (e *ReservationStatusEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ReservationStatusEntity) Deleted() bool {
	return e.deleted
}


func (e *ReservationStatusEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewReservationStatusEntity(e.client, opts)
}

func (e *ReservationStatusEntity) Data(args ...any) any {
...
func (e *ReservationStatusEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *ReservationStatusEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ReservationStatusEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ReservationStatusEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ReservationStatusEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ReservationStatusEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ReservationStatusEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
