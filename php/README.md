...
The PHP SDK for the Nextbike API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->LiveData(null)->list(null, null);
...
[$result, $err] = $client->Nextbike(null)->load(
    ["id" => "test01"], null
);
