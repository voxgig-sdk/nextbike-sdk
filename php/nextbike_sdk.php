...
class NextbikeSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = NextbikeHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = NextbikeHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!NextbikeFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, NextbikeFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return NextbikeUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = NextbikeHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = NextbikeHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = NextbikeHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new NextbikeError($op . "_allow",
                "NextbikeSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = NextbikeHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new NextbikeError("graphql_error",
                "NextbikeSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Public($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_public === null) {
                $this->_public = new PublicEntity($this, null);
            }
            return $this->_public;
        }
        return new PublicEntity($this, $data);
    }
    ...
    public function Reservation($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_reservation === null) {
                $this->_reservation = new ReservationEntity($this, null);
            }
            return $this->_reservation;
        }
        return new ReservationEntity($this, $data);
    }
    ...
    public function ReservationStatus($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_reservation_status === null) {
                $this->_reservation_status = new ReservationStatusEntity($this, null);
            }
            return $this->_reservation_status;
        }
        return new ReservationStatusEntity($this, $data);
    }
