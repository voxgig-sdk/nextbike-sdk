...
// Nextbike SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class NextbikeTestFeature extends NextbikeBaseFeature
{
    ...
    public function init(NextbikeContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (NextbikeContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (NextbikeContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(NextbikeContext $ctx, $op, $args): array
    {
