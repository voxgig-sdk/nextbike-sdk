...
class NextbikeTimeoutFeature extends NextbikeBaseFeature
{
    ...
    private function _with_timeout(NextbikeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(NextbikeContext $_ctx, float $ms): void
    {
        $client = $this->client;
