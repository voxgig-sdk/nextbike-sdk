...
// Nextbike SDK ratelimit feature
...
class NextbikeRatelimitFeature extends NextbikeBaseFeature
{
    ...
    private function _acquire(NextbikeContext $ctx): void
    {
    ...
    private function _track(NextbikeContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
