...
// Nextbike SDK streaming feature
...
class NextbikeStreamingFeature extends NextbikeBaseFeature
{
    ...
    private function _iterate(NextbikeResult $result): \Generator
    {
    ...
    private function _streamable(NextbikeContext $ctx): bool
    {
