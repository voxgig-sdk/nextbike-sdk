...
// Nextbike SDK clienttrack feature
...
class NextbikeClienttrackFeature extends NextbikeBaseFeature
{
    ...
    public function PostConstruct(NextbikeContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Nextbike-SDK';
