...
class NextbikeProxyFeature extends NextbikeBaseFeature
{
    ...
    public function init(NextbikeContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (NextbikeContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
