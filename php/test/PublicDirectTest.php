...
class PublicDirectTest extends TestCase
{
    public function test_direct_load_public(): void
    {
        $setup = public_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-public", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
