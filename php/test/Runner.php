...
class NextbikeTestRunner
{
    ...
    {
        $live = self::getenv('NEXTBIKE_TEST_LIVE');
        $override = self::getenv('NEXTBIKE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('NEXTBIKE_TEST_EXPLAIN');
...
class_alias('NextbikeTestRunner', 'Runner');
class_alias('NextbikeHelpers', 'Helpers');
