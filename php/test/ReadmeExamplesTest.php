...
// Nextbike SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (NextbikeSDK::test)
...
{
    private const SDK_CLASS = 'NextbikeSDK';
    ...
    private const SDK_BASE = 'nextbike_sdk';
