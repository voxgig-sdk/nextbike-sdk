...
class ReservationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ReservationEntity(self._client, opts)
    ...
    def match_get(self) -> Reservation:
    ...
    def create(self, reqdata: ReservationCreateData, ctrl=None) -> Reservation:
        utility = self._utility
