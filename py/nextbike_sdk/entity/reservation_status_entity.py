...
from nextbike_sdk.nextbike_types import (
    ReservationStatus,
...
class ReservationStatusEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ReservationStatusEntity(self._client, opts)
    ...
    def data_get(self) -> ReservationStatus:
    ...
    def match_get(self) -> ReservationStatus:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ReservationStatus:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ReservationStatus().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
