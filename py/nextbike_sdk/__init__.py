...
from nextbike_sdk.utility import register

# Load features
from nextbike_sdk.feature.base_feature import NextbikeBaseFeature
from nextbike_sdk.features import _has_feature, _make_feature
...
class NextbikeSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = NextbikeUtility()
        self._utility = utility

        from nextbike_sdk.config import shared_config
    ...
    def get_utility(self):
        return NextbikeUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("NextbikeSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def LiveData(self, data=None) -> "LiveDataEntity":
        ...
        from nextbike_sdk.entity.live_data_entity import LiveDataEntity
    ...
    def Public(self, data=None) -> "PublicEntity":
        ...
        from nextbike_sdk.entity.public_entity import PublicEntity
    ...
    def Reservation(self, data=None) -> "ReservationEntity":
        ...
        from nextbike_sdk.entity.reservation_entity import ReservationEntity
    ...
    def ReservationStatus(self, data=None) -> "ReservationStatusEntity":
        ...
        from nextbike_sdk.entity.reservation_status_entity import ReservationStatusEntity
