# Nextbike SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions NextbikeSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both NextbikeSDK(...) and NextbikeSDK.test(...) become
#      NextbikeSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "nextbike_sdk"
_SDK_CLASS = "NextbikeSDK"
