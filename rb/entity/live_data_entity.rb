...
class LiveDataEntity
  ...
  #
  # @param reqmatch [LiveDataListMatch, Hash, nil] match filter (any subset of
  #   LiveData fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<LiveData>, Array] the matching LiveData items; raises NextbikeError on failure
