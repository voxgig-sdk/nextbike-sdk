...
module NextbikeTestRunner
  ...
  def self.env_override(m)
    live = getenv("NEXTBIKE_TEST_LIVE")
    override = getenv("NEXTBIKE_TEST_OVERRIDE")
    ...
    explain = getenv("NEXTBIKE_TEST_EXPLAIN")
    m["NEXTBIKE_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = NextbikeTestRunner
Helpers = NextbikeHelpers
Vs = VoxgigStruct
